...
const Unit2 = () => {
    ...
    const logoRef = useGsapEntrance({ delay: 0.1, start: "top 85%" });
    const locale = useLocale() as Locale;
    const { unit2 } = homeContent[locale] ?? homeContent.en;

    return (
        <div ref={sectionRef} className=" border-b-[1px] border-solid border-[rgba(22,7,4,0.12)] pb-[24px] mobile:pb-[16px]">
            <div
                className="w-[1320px] px-[95px] pt-[44px] h-[367px] rounded-[12px] mx-auto  bg-[rgba(255,76,51,0.03)] mt-[24px] border-solid border-[1px] border-[rgba(22,7,4,0.09)] mobile:w-full mobile:px-[20px] mobile:pt-[24px] mobile:h-auto mobile:pb-[24px] mobile:mt-[16px]">
                <div className="flex">
                ...
                <div ref={logoRef} className=" relative flex flex-wrap mt-[18px] mobile:mt-[16px] w-[calc(100%+3px)]">
